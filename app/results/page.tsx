...
export default function ResultsAndReportsPage() {
  return (
    <Shell title="Results & Reports" subtitle="Browse and download reconstruction results and generated analysis reports">
      <div className="flex flex-col gap-8">
        
        {/* --- RESULTS SECTION --- */}
        <div>
          <h2 className="text-lg font-bold text-foreground mb-4">Reconstruction Results</h2>
        ...
        {/* --- REPORTS SECTION --- */}
        <div>
          <h2 className="text-lg font-bold text-foreground mb-4">Analysis Reports</h2>
          <div className="flex flex-col gap-5">
                    ...
                    <div key={r.id} className="flex items-center gap-4 rounded-lg border border-border/50 bg-card px-4 py-3 hover:bg-muted/30 transition-colors cursor-pointer group">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2 mb-0.5">
                          ...
                          <span className={cn("inline-flex items-center rounded-md border px-1.5 py-0.5 text-[10px] font-semibold", typeColor[r.type] ?? "bg-muted text-muted-foreground border-border")}>{r.type}</span>
                        </div>
